...
local function reportScore(time)
   ...
   -- [New] Sarcastic Comments for Results (Player Boasting/Excuses)
   local RESULT_COMMENTS = {
       White = { "刚才网卡了...", "这车手感不对!", "键盘冒奶了!", "谁踢我网线?", "我在回消息!", "让你们先跑一会!", "这物理有问题!" },
       Blue = { "刚热身完!", "也就用了三成力!", "随便跑跑!", "还没认真呢!", "这图太滑了!", "刚才手滑了一下!", "差不多得了!" },
       Green = { "基操勿6!", "正常发挥!", "跟得上吗弟弟?", "还有谁?", "稍微认真了一点!", "勉强能看吧!", "下把认真跑!" },
       Gold = { "这就叫实力!", "看不见我的尾灯吗?", "你们是在倒车吗?", "太慢了太慢了!", "教你们做人!", "这就叫追走!", "无敌是多么寂寞!" },
       Purple = { "我是神!", "甚至不需要看路!", "这游戏太简单了!", "让你们一只手都能赢!", "凡人这就是差距!", "请叫我车神!", "你们是来散步的吗?" }
   }
